...
image bg sand2 = Transform("gui/images/bg/sand2.png", xysize=(SW, SH))
image bg sand3 = Transform("gui/images/bg/sand3.png", xysize=(SW, SH))
image bg sand4 = Transform("gui/images/bg/sand4.png", xysize=(SW, SH))
image bg sand5 = Transform("gui/images/bg/sand5.png", xysize=(SW, SH))
image bg sand6 = Transform("gui/images/bg/sand6.png", xysize=(SW, SH))
